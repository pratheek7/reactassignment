...
var TimePicker = /*#__PURE__*/React__default["default"].forwardRef(function TimePicker(_ref, ref) {
  ...
  var timePickerClasses = cx__default["default"]((_cx2 = {}, _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker"), true), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--light"), light), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--invalid"), invalid), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--readonly"), readOnly), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--").concat(size), size), _rollupPluginBabelHelpers.defineProperty(_cx2, className, className), _cx2));
  ...
  function getInternalPickerSelects() {
    ...
    var mappedChildren = React__default["default"].Children.map(children, function (pickerSelect) {
      return /*#__PURE__*/React__default["default"].cloneElement(pickerSelect, _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, pickerSelect.props), {}, {
        disabled: disabled,
        readOnly: readOnly
